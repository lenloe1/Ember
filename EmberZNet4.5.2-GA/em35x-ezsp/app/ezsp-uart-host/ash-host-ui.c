...
"    -v[base-port]     enables virtual ISA support.  The [base-port] argument is optional.\n"
"                      Both serial ports are available via telnet instead of local console\n"
"                      RAW serial port is available on the first port (offset 0 from base port),\n"
"                      and the CLI is available on the second port (offset 1 from base port).\n"
"                      By default, 4900 is the base-port, therefore RAW access is available \n"
"                      from port 4900, and CLI access is available from port 4901\n"
"                      NOTE:  No space is allowed betwene '-v' and the [base-port].\n"
