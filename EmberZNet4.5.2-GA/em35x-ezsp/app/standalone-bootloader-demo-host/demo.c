...
void demoNetworkCB(void)
{
  ...
  if (cliCompareStringToArgument("form", 1) == TRUE)
  {
    ...
    bmask = EMBER_NO_TRUST_CENTER_MODE | EMBER_GLOBAL_LINK_KEY 
       | EMBER_HAVE_PRECONFIGURED_KEY | EMBER_HAVE_NETWORK_KEY;
  ...
  else if (cliCompareStringToArgument("join", 1) == TRUE)
  {
    ...
    bmask = EMBER_GLOBAL_LINK_KEY | EMBER_HAVE_PRECONFIGURED_KEY | 
