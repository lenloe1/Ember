...
// calling emberAfSetNoReplyForNextMessage. The reply can be sent to another
// PAN by calling emberAfSetReplyForInterPAN.
...
// DEPRECATED.
void emberAfSendReadAttribute(int16u dest, int16u cluster, int16u attribute);
