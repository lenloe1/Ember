HA Switch Sample Application

<app name> = HASwitch

About the Application:

   The HASwitch application is intended to be used in conjunction with HALight 
   located in ha-light.
...
To run the application:
   ...
   3. To manipulate the light (on/off attribute), use the following commands:
      Turn the light on:
