...
// Also 32-bit divide and modules can be expensive (e.g. on the XAP) so wherever
...
#if defined (EXTRA_DEBUG_PRINTING) || defined(EMBER_TEST)
...
#define EMBER_AF_PLUGIN_OTA_CLIENT_PAGE_REQUEST_TIMEOUT_MS \
  (EMBER_AF_PLUGIN_OTA_CLIENT_PAGE_REQUEST_TIMEOUT_SECONDS * MILLISECOND_TICKS_PER_SECOND * 1L)
