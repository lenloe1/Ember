...
#define LOAD_CONTROL_EVENT_TABLE_ENTRY_BYTES 29
#define LOAD_CONTROL_EVENT_TABLE_MEM_FOOTPRINT (EMBER_AF_PLUGIN_DRLC_EVENT_TABLE_SIZE * \
  LOAD_CONTROL_EVENT_EVENT_TABLE_ENTRY_BYTES)
 ...
 *
 */
void emAfScheduleLoadControlEvent(EmberAfLoadControlEvent *event);
 ...
 * ESP and or react to scheduled events. The event
