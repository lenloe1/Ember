...
#define EMBER_AF_PLUGIN_SMART_ENERGY_REGISTRATION_DELAY_BRIEF      MILLISECOND_TICKS_PER_SECOND
...
// 5.4.9.2 of 105638r09.
  ...
  // is not defined, and the plugin won't schedule an event to rediscover ESIs.
    ...
    #define EMBER_AF_PLUGIN_SMART_ENERGY_REGISTRATION_DELAY_PERIOD            \
      ((int32u)EMBER_AF_PLUGIN_SMART_ENERGY_REGISTRATION_ESI_DISCOVERY_PERIOD \
       * (int32u)MILLISECOND_TICKS_PER_HOUR)
  #endif
...
extern EmberEventControl emAfPluginSmartEnergyRegistrationEventControl;
