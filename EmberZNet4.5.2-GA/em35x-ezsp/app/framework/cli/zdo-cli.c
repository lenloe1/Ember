...
static EmberCommandEntry zdoClusterCommands[] = {
  {"add", zdoAddClusterCommand, "v"},
  {"clear", zdoClearClusterCommand, ""},
  { NULL }
};

static EmberCommandEntry zdoNetworkUpdateCommands[] = {
  {"chan", zdoNetworkUpdateChannelCommand, "u"},
  {"scan", zdoNetworkUpdateScanCommand,    "vuv"},
  {"set",  zdoNetworkUpdateSetCommand,     "vw"},
  { NULL }
};

EmberCommandEntry zdoCommands[] = {
  {"nwk",         zdoNwkAddressRequestCommand,             "b" },
  {"ieee",        zdoIeeeAddressRequestCommand,            "v" },
  {"simple",      zdoSimpleCommand,                        "vu"},
  {"node",        zdoNodeCommand,                          "v"},
  {"match",       zdoMatchCommand,                         "vv"},
  {"bind",        zdoBindCommand,                          "vuuvbb"},
  {"active",      zdoActiveEpCommand,                      "v" },
  {"in-cl-list",  NULL, (PGM_P)zdoClusterCommands},
  {"out-cl-list", NULL, (PGM_P)zdoClusterCommands},
  {"nwk-upd",     NULL, (PGM_P)zdoNetworkUpdateCommands},
  { NULL }
};
...
static void zdoIeeeAddressRequestCommand(void)
{
  EmberNodeId id = emberUnsignedCommandArgument(0);
