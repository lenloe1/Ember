 ...
 *
 *        <b>zcl ota client stop</b>
 *        - <i>Stops the OTA state machine.</i>
 *
 *        <b>zcl ota client printImages</b>
 *        - <i>Prints all images stored in the OTA storage module along with
 *             their indexes.</i>
 *
 *        <b>zcl ota client delete &lt;index&gt;</b>
 *        - <i>Deletes the image located at the index specified.
 *           - index - int8u. The location of the image to delete</i>
 *
 *        <b>zcl ota client status</b>
 *        - <i>Prints information on the current state of the OTA client
 *             download.</i>
 *
 *        <b>zcl ota client block-test</b>
 *        - <i></i>
 *
 *        <b>zcl ota client page-request</b>
 *        - <i></i>
 *
 */
...
//------------------------------------------------------------------------------
// Globals
EmberCommandEntry otaClientCommands[] = {
  {"bootload",    (CommandAction)otaCliBootload,        "u"},
  {"verify",      (CommandAction)otaCliVerify,          "u"},
  {"info",        (CommandAction)otaPrintClientInfo,    ""},
  {"start",       (CommandAction)otaStartClientCommand, ""},
  {"stop",        (CommandAction)otaStopClientCommand,  ""}, 

  // This is a duplicate of the same command on the server.  However
  // since devices may not have client and server defined, we need it here.
  {"printImages",   (CommandAction)emAfOtaPrintAllImages, "" },
  {"delete",         (CommandAction)emAfOtaImageDelete, "u"},
  {"status",      (CommandAction)emAfOtaClientPrintState, "" },

  {"block-test",  (CommandAction)emAfSendImageBlockRequestTest, "" },

  {"page-request", (CommandAction)setPageRequest, "u"},
...
static void otaPrintClientInfo(void)
{
  ...
  otaPrintln("Current Version:  0x%2X", myId.firmwareVersion);
