 ...
 * only on compatible Ember stacks.
 *
 * Broadcast table entries are 5 bytes in size.
 */
#ifndef EMBER_BROADCAST_TABLE_SIZE
  #define EMBER_BROADCAST_TABLE_SIZE 15
#elif EMBER_BROADCAST_TABLE_SIZE < 15
  #error "EMBER_BROADCAST__TABLE_SIZE is less than the minimum value of 15."
#elif 254 < EMBER_BROADCAST_TABLE_SIZE
  #error "EMBER_BROADCAST__TABLE_SIZE is larger than the maximum value of 254."
#endif
...
#if defined(EMBER_PSL_STACK)

  #ifndef EMBER_PSL_GROUP_ADDRESSES
  /** @brief The number of unique group identifiers that this device requires.
   */
    #define EMBER_PSL_GROUP_ADDRESSES 1
  #endif

  #ifndef EMBER_PSL_RSSI_THRESHOLD
  /** @brief The RSSI threshold applied to incoming scan requests.
   */
    #define EMBER_PSL_RSSI_THRESHOLD -128
  #endif

#endif // EMBER_PSL_STACK
